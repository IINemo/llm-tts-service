        ...
        try:
            ...
            if wandb.run is not None:
                ...
                if flop_calculator and sample_tokens > 0:
                    ...
                    running_total_tflops = flop_calculator.compute_tflops(sum(all_sample_tokens))
                ...
                sample_metrics = {
                    ...
                    "running_avg_tflops_per_sample": running_total_tflops / len(results) if results else 0,
                    ...
                    if all_traces and "token_confs" in all_traces[0] and all_traces[0]["token_confs"]:
                        for t_idx, trace in enumerate(all_traces):
                            ...
                            if tc:
                                ...
                                trace_charts[f"conf_charts/sample_{i}/trace_{t_idx}"] = chart
...
def main(config):
    ...
    if model_name:
        try:
            ...
            log.info(f"FLOP calculator initialized: {flop_calculator.tflops_per_1k_tokens:.3f} TFLOPs/1k tokens")
        except Exception as e:
