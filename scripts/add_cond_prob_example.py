#!/usr/bin/env python3
"""Add conditional probability example to cached_examples.json."""
...
Q = {
    ...
    "question": (
        "A box contains 5 red, 4 blue, and 3 green balls. Three balls are drawn "
        "without replacement. Given that at least one ball is red, what is the "
        "probability that all three balls are different colors? Express your answer "
        "as a fraction."
    ),
    "ground_truth": "12/37",
}
